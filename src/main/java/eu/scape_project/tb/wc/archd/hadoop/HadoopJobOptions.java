...
public class HadoopJobOptions {
    ...
    private static Logger logger = LoggerFactory.getLogger(HadoopJobOptions.class.getName());
    ...
    public static final String DIR_OPT_DESC = "HDFS directory web archive container files.";
